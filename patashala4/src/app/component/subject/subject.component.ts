  ...
  this.masterCourseTOList=masterCourseTOList;
    ...
    addSubjectSubmit({value, valid}: { value: MasterCourseTO, valid: boolean })
    {
      var syllabusList = new Array <SyllabusIdNameTO> ( );
      var masterCourseTO = new MasterCourseTO();
        var syllabus1 = new SyllabusIdNameTO();
    ...
    deleteSyllabusName(i: number) {
      ...
      const control = <FormArray>this.subjectFormGroup.controls['syllabusList'];
    ...
    addSyllabusName() {
      // control refers to your formarray
      const control = <FormArray>this.subjectFormGroup.controls['subjectList'];
      // add new formgroup
