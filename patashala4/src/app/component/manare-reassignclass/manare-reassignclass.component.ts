...
@Component({
  selector: 'app-manare-reassignclass',
  templateUrl: './manare-reassignclass.component.html',
  providers: [StudentService, {provide: "StudentConverter", useClass: StudentConverterImpl}],
  styleUrls: ['./manare-reassignclass.component.css']
})
export class ManareReassignclassComponent implements OnInit, StudentComponentInterface  {
  className: any;
...
//    console.log("displayStudentCallBack "+studentTO.mobileNumbers.length);
  ...
  onNotify(status:string,schoolId: string, studentId: string ):void {
    //alert(status);
    this.showClassSelection=false;
    if(status=="true")
    {
     this.studentTO = localStorage.getStudent(AppConstants.SHAREDPREFERANCE_STUDENTID,studentId,this);
     console.log("local val" + this.studentTO);
      var studentnew = new StudentTO();
      studentnew.classId = localStorage.getItem(AppConstants.SHAREDPREFERANCE_STUDENTCLASSID);
      studentnew.className = localStorage.getItem(AppConstants.SHAREDPREFERANCE_STUDENTCLASSNAME)
      studentnew.firstName = this.studentTO.firstName;
      studentnew.lastName = this.studentTO.lastName;
      studentnew.middleName = this.studentTO.middleName;
      studentnew.gender = this.studentTO.gender;
      studentnew.landLine = this.studentTO.landLine;
      studentnew.addressOne = this.studentTO.addressOne;
      studentnew.addressTwo = this.studentTO.addressTwo;
      studentnew.city = this.studentTO.city;
      studentnew.state = this.studentTO.state;
      studentnew.country = this.studentTO.country;
      studentnew.pincode = this.studentTO.pincode;
      studentnew.bloodGroup = this.studentTO.bloodGroup;
      studentnew.dateOfBirth = this.studentTO.dateOfBirth;
      // studentnew.profilePhotoUrl = this.studentTO.profilePhotoUrl;
      studentnew.fatherName = this.studentTO.fatherName;
      studentnew.motherName = this.studentTO.motherName;
      studentnew.rollNo = this.studentTO.rollNo;
    
      this.studentConverter.updateStudent(localStorage.getItem(AppConstants.SHAREDPREFERANCE_SCHOOLID),studentnew, this);
      // this.studentTO.className
      ...
      // this.updateclassfun();
      console.log("calss name"+ this.className);
    }
